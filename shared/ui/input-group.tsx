...
function InputGroup({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      role="group"
      className={cn(
        'group/input-group bg-card border border-white/5 rounded-small relative flex w-full items-center transition-colors outline-none',
...
function InputGroupInput({
  ...
  return (
    <Input
      ...
      className={cn(
        'flex-1 rounded-none border-0 bg-transparent shadow-none focus-visible:ring-0 h-auto px-5',
        className,
      )}
      {...props}
    />
